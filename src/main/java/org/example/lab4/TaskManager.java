...
public class TaskManager {
    ...
    public void addAndStartTask(MonteCarloAdjust monteCarloAdjust) {
        Thread thread = new Thread(monteCarloAdjust);
        tasks.put(monteCarloAdjust.getId(), thread);
        thread.start();
        ConsolePrinter.taskStarted(monteCarloAdjust.getId());
    }
